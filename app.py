...
for _key, _default in [
    ("last_query", ""),
    ("last_result", None),
    ("llm_answer", None),   # result dict from generate()
...
def _render_trail(result: dict, llm_triggered: bool = False):
    ...
    if llm_triggered:
        parts.append('<span class="trail-sep">→</span>')
        parts.append(step("✓", "Generated answer", "trail-pass"))
...
<div class="no-match-card">
  ...
  <p style="margin:0;opacity:0.7;">
    ...
    below address what you asked — if not, generate an answer at the bottom.
  </p>
</div>""",
        unsafe_allow_html=True,
    )
...
<div class="no-match-card">
  ...
  <p style="margin:0;opacity:0.65;">
    ...
    relevant information for your question. You can generate a general answer
  ...
  <div class="llm-disclaimer">
    ...
    Always verify important information against the original source.
        ...
        st.markdown(
            f"""
<div class="llm-card">
  <span class="result-mode-badge badge-llm">Generated Answer</span>
  <p>{answer_esc}</p>
  <div class="llm-disclaimer">
...
if st.session_state.get("search_error"):
    ...
    if mode == "qa_answer":
        ...
        if score >= HIGH_CONF_THRESHOLD:
            ...
            if not llm_triggered:
                if st.button(
                    "Not satisfied? Get a generated answer \u2192",
                    key="ai_btn_qa",
                ):
            ...
            if not llm_triggered:
                if st.button(
                    "None of these answer your question? Get a generated answer \u2192",
                    key="ai_btn_low",
                ):
                    with st.spinner("Generating answer..."):
                        try:
    ...
    # ── Generated answer (rendered below whichever tier triggered it) ──────────
    if llm_triggered:
